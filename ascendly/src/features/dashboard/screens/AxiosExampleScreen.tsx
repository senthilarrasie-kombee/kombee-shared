  ...
  const renderItem = ({item}: {item: Post}) => (
    <View style={styles.postCard}>
      ...
      <View style={styles.actionButtons}>
        <TouchableOpacity style={[styles.actionButton, styles.editButton]} onPress={() => handleUpdatePost(item.id)}>
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          refreshControl={
            <RefreshControl refreshing={refreshing} onRefresh={() => fetchPosts(true)} colors={[colors.primary]} />
          }
        />
      )}
