  ...
  return (
    <TouchableOpacity
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.titleRow}>
            <AppText style={[styles.habitTitle, {color: colors.textPrimary}]}>{item.title}</AppText>
            {!item.isOneTime && (
          ...
          <View style={styles.badgeRow}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    item.priority === 'high' ? '#FFEBEB' : item.priority === 'medium' ? '#FFF8E1' : '#E3F2FD',
                },
              ]}>
              <AppText
                style={[
      ...
      <View style={styles.cardFooter}>
        ...
        {showAction && (
          <TouchableOpacity
            style={[styles.addButton, {backgroundColor: isCompletedOnDate ? '#4CAF50' : colors.primary}]}
            onPress={() => onActionPress && onActionPress(item)}>
            <Icon name={isCompletedOnDate ? 'checkmark-circle' : 'add'} size={20} color="#FFFFFF" />
          </TouchableOpacity>
        )}
      </View>
    </TouchableOpacity>
