...
import {View, StyleSheet, TouchableOpacity, ScrollView, Dimensions, Switch, Alert} from 'react-native';
...
import {signOut, bulkUploadHabits, deleteUserHabits} from '@core';
          ...
          <View style={[styles.section, {marginTop: 20}]}>
            ...
            <TouchableOpacity
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <AppText style={styles.menuItemTitle}>{isUploading ? 'Uploading...' : 'Update Habits Data'}</AppText>
              </View>
              <Icon name="chevron-forward" size={18} color={colors.textSecondary} />
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[
                styles.menuItem,
                {backgroundColor: isDark ? '#1C1C27' : '#FFFFFF', borderColor: colors.border, marginTop: 12},
              ]}
