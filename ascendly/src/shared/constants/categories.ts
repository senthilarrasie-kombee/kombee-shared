export const CATEGORIES_DATA = [
  ...
  {id: 'productivity', name: 'Work & Productivity', icon: 'briefcase', color: '#FFD93D'},
  {id: 'finance', name: 'Finance', icon: 'wallet', color: '#845EC2'},
  {id: 'personal', name: 'Personal Life', icon: 'home', color: '#FF9671'},
  {id: 'nutrition', name: 'Nutrition & Diet', icon: 'nutrition', color: '#00C9A7'},
  {id: 'sleep', name: 'Sleep & Recovery', icon: 'moon', color: '#2C73D2'},
  {id: 'relationships', name: 'Relationships', icon: 'people', color: '#F9A826'},
